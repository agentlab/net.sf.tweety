...
public class ProbTest {
	...
	public static void main(String[] args) throws ParserException, IOException{
		...
		NaiveMlnReasoner reasoner = new NaiveMlnReasoner(sig);
		reasoner.setTempDirectory("/Users/mthimm/Desktop/tmp");
		
		System.out.println(w + "\t\t" + reasoner.query(mln, (FolFormula)parser.parseFormula("a(d1) && b(d1) || c(d1) && d(d1)")).getAnswerDouble());
