...
public class DelpParser implements Parser<DelpRule>, DelpParserConstants {

        private FolSignature signature = new FolSignature();

        public DelpParser() { this(new StringReader("")); }

        public BeliefBase<DelpRule> parseBeliefBase(Reader reader) throws ParserException{
                try {
                        ReInit(reader);
     ...
     */
        public DelpRule parseFormula(Reader reader) throws ParserException{
                try {
                        ReInit(reader);
