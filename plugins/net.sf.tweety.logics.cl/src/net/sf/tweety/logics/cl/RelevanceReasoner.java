 ...
 * 
 * James P. Delgrande. Relevance, Conditionals, and Defeasible Reasoning. In
 * preparation.
 * 
...
public class RelevanceReasoner implements Reasoner<Conditional, Formula> {
	...
	/**
	 * The extension of the knowledgebase. Once this extension has been computed
	 * it is used for subsequent queries in order to avoid unnecessary
	 * computations.
	 */
