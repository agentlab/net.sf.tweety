...
/**
 * This class models a belief set on relational conditional logic, i.e. a set of
...
public class RclBeliefSet extends BeliefSet<RelationalConditional> {
	...
	/**
	 * Creates a new relational conditional belief set with the given collection
	 * of relational conditionals.
	 * 
	 * @param conditionals
